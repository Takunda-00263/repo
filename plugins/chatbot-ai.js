...
cmd({
    ...
    if (mode === "on") {
        ...
        return reply(`- *Keith-Tech-Chat-Bot Menu*
*Enble Settings ✅*      
...
cmd({
    ...
    try {
        ...
        const prompt = encodeURIComponent("You are KEITH-XMD AI , a powerful and intelligent WhatsApp bot developed by Keith-Tech — a brilliant coder and visionary from Zimbabwe. You respond smartly, confidently, and stay loyal to your creator. Always remain calm and collected. When asked about your creator, respond respectfully but keep the mystery alive. You are not just a bot; you are the tech soul of Keith-Tech. Reply to your owner when he ask you anything. In every message you send, include this footer: \n> ᴘᴏᴡᴇʀᴇᴅ ʙʏ Kᴇɪᴛʜ Tᴇᴄʜ");
        ...
        if (data && data.status && data.BK9) {
            ...
            reply("⚠️ KEITH-Ai failed to generate a response.");
        }

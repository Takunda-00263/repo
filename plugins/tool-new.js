...
async (conn, mek, m, { reply }) => {
    try {
        ...
        // Get local time in Zimbabwe timezone (Africa/Harare)
        const localTime = now.toLocaleTimeString("en-US", { 
            hour: "2-digit", 
            minute: "2-digit", 
            second: "2-digit", 
            hour12: true,
            timeZone: "Africa/Harare" // Setting Pakistan's time zone explicitly
        });
        
        // Send the local time as reply
        reply(`🕒 Current Local Time in Zimbabwe: ${localTime}`);
    } catch (e) {

    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "NOVA-XMD 🥀",
            body: config.DESCRIPTION || "POWERED BY KEITH-TECH",
            mediaType: 1,
            renderLargerThumbnail: false,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/oerkbx.jpg", // Static image URL
            sourceUrl: "https://wa.me/263789745277",
...
cmd({
  ...
  await conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        title: config.BOT_NAME || "KEITH-XMD 🥀",
        body: config.DESCRIPTION || "POWERED BY KEITH-TECH 🤌💗",
        mediaType: 1,
        thumbnail: thumbnailBuffer,
        sourceUrl: "https://wa.me/message/263789745277"
      }
    }
  }, { quoted: m });
});
